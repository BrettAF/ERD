# -*- coding: utf-8 -*-
"""Text files Reader and CSV labeler

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15mbuZpOp6srhJXfpg6vJp5jZniY5gv20
"""
...
consistent_channels=["Time","FP1-F7"," F7-T7", "T7-P7", "P7-O1", "FP1-F3", "F3-C3", "C3-P3"," P3-O1", "FP2-F4","F4-C4", "C4-P4", "P4-O2", "FP2-F8", "F8-T8", "T8-P8", "P8-O2", "FZ-CZ","CZ-PZ","Label","EEG Time"]
...
for line in summaryfile:
  ...
  if fn_search:
    toopen=line[(fn_search.span()[0]):(fn_search.span()[1]-4)]+" filtered.csv"
...
def convertFile(file_name, recording_start_time):
  with open(file_name,'r') as csvinput:
    output_name = str(file_name[0:-4] )+ " formated.csv"
    print(output_name)
    with open(output_name, 'w') as csvoutput:
      ...
      for row in reader:
          ...
          row_to_keep.append(float(row[0])/1000+recording_start_time)
          row_to_keep.append(  assignLabel(  float(row[0])/1000 + recording_start_time)  )
