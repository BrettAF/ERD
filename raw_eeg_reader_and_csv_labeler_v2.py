...
def summaryReader(folder):
  ...
  for line in summaryfile:
    ...
    ss_search=re.search("Seizure \d* Start Time: \d+",line)
    if ss_search:
      print(line[(ss_search.span()[1]-4):(ss_search.span()[1])])
      seizure_start_times.append(time_since_recording_began + int(line[(ss_search.span()[1]-4):(ss_search.span()[1])]))
    #This searches for seizure end
    se_search = re.search("Seizure \d* End Time: \d+",line)
    if se_search:
      seizure_end_times.append(time_since_recording_began + int(line[(se_search.span()[1]-4):(se_search.span()[1])]))
  print(eeg_files)
...
folders = [ 'chb06','chb07','chb08','chb09', 'chb10','chb11','chb12','chb13', 'chb14','chb15','chb16','chb17', 'chb18','chb19','chb20','chb21', 'chb22','chb23','chb24',]
