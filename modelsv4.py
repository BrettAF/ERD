...
Original file is located at
    https://colab.research.google.com/drive/1ehKCNsgRI5netMZ_Ctq2TURhJBELsrde
"""
...
def funDenseLSTM(my_training_generator,window_size,number_of_channels,my_validation_generator):
  number_of_channels=18

  outputs=2
  input_shape = ( window_size, number_of_channels, 1)

  DenseLSTM = keras.Sequential([
      layers.Reshape((window_size/2,number_of_channels*2),input_shape=input_shape),
      layers.Dense(145),
      layers.Dense(145),
  ...
  DenseLSTM.fit(my_training_generator,
                   epochs = number_of_epochs,
                   verbose = 1, validation_data=my_validation_generator)
  #DenseLSTM.save("DenseLSTM")
  return DenseLSTM

def funLongConvLSTM(my_training_generator,window_size,number_of_channels,my_validation_generator):
  number_of_channels=18
  ...
  longConvLSTM = keras.Sequential([
      ...
      layers.MaxPool2D( pool_size=(42, 1,)),
      layers.Dense(145),
      layers.Reshape((252,145)),
      layers.LSTM(73, activation='relu' ),
      layers.Dense(73),
      layers.Dense(40),
      layers.Dense(outputs,activation='softmax')
...
longConvLSTM=funLongConvLSTM(my_training_generator,window_size,number_of_channels,my_validation_generator)
denseLSTM=funDenseLSTM(my_training_generator,window_size,number_of_channels,my_validation_generator)
