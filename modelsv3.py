...
m2dlstm=fun2dlstm(training_data,training_labels,window_size,my_validation_generator)
#m1DLSTM=fun1DLSTM(training_data,training_labels,window_size,my_validation_generator)
#m2Dconv=fun2Dconv(training_data,training_labels,window_size,my_validation_generator)
...
def fun2dlstm(training_data,training_labels,window_size, my_validation_generator):
  number_of_channels=18
...
def fun1DLSTM(training_data,training_labels,window_size, validation_data, validation_labels):
  input_shape = ( window_size, number_of_channels, 1)
...
def fun2Dconv(training_data,training_labels,window_size, validation_data, validation_labels):
  number_of_channels=18
  outputs=2
